...
import io.github.jean.core.designsystem.generated.resources.search_empty_desc
import io.github.jean.core.designsystem.generated.resources.search_empty_title
import io.github.jean.core.designsystem.generated.resources.search_start_desc
import io.github.jean.core.designsystem.generated.resources.search_start_title
...
fun SearchEmptyContent(
    ...
    val (title, desc) =
        if (keyword.isNotBlank()) {
            stringResource(Res.string.search_empty_title) to stringResource(Res.string.search_empty_desc)
        } else {
            stringResource(Res.string.search_start_title) to stringResource(Res.string.search_start_desc)
        }
