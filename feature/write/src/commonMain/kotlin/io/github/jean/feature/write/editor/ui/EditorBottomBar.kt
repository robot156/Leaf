...
import io.github.jean.core.designsystem.generated.resources.editor_quote_add
...
fun EditorBottomBar(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        Row(
            ...
            LeafOutlinedButton(
                text = stringResource(Res.string.editor_quote_add),
...
private fun EditorBottomBarPreview() {
    LeafTheme {
        EditorBottomBar(
            hint = stringResource(Res.string.editor_char_count, 62),
            onIntent = {},
        )
    }
}
