...
import io.github.jean.core.designsystem.generated.resources.search_detail_description
import io.github.jean.core.designsystem.generated.resources.search_detail_external_link
import io.github.jean.core.designsystem.generated.resources.search_detail_isbn
import io.github.jean.core.designsystem.generated.resources.search_detail_select
...
fun SearchBookDetailBottomSheet(
    ...
    LeafBottomSheet(
        ...
        content = {
            Column(
                    ...
                    text =
                        listOfNotNull(
                            ...
                            uiModel.isbn13
                                ...
                                ?.let { stringResource(Res.string.search_detail_isbn, it) },
                        ).joinToString(" · "),
                    style = LeafTheme.typography.meta,
                ...
                if (uiModel.description.isNotBlank()) {
                    Text(
                        text = stringResource(Res.string.search_detail_description),
                ...
                if (uiModel.link.isNotBlank()) {
                    LeafTextButton(
                        ...
                        text = stringResource(Res.string.search_detail_external_link),
        ...
        bottomBar = {
            LeafSolidButton(
                text = stringResource(Res.string.search_detail_select),
