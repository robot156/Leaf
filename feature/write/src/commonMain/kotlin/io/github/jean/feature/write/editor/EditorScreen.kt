...
import io.github.jean.core.designsystem.generated.resources.editor_book_choice
import io.github.jean.core.designsystem.generated.resources.editor_char_count
import io.github.jean.core.designsystem.generated.resources.editor_exit_dialog_cancel
import io.github.jean.core.designsystem.generated.resources.editor_exit_dialog_confirm
import io.github.jean.core.designsystem.generated.resources.editor_exit_dialog_description
import io.github.jean.core.designsystem.generated.resources.editor_exit_dialog_title
import io.github.jean.core.designsystem.generated.resources.editor_new_note
import io.github.jean.core.designsystem.generated.resources.editor_note
import io.github.jean.core.designsystem.generated.resources.editor_save
import io.github.jean.core.designsystem.theme.LeafTheme
import io.github.jean.core.ui.navigation.LeafBackHandler
...
fun EditorRoute(
    ...
    LeafBackHandler(enabled = state.hasUnsavedChanges) {
...
private fun EditorScreen(
    ...
    Scaffold(
        ...
        topBar = {
            LeafTopNavigation(
                title = stringResource(if (state.noteId == null) Res.string.editor_new_note else Res.string.editor_note),
                leading =
                    LeafTopNavItem.Icon(
        ...
        content = {
            Column(
                ...
                if (state.book == null) {
                    LeafOutlinedButton(
                        text = stringResource(Res.string.editor_book_choice),
        ...
        bottomBar = {
            EditorBottomBar(
                hint = stringResource(Res.string.editor_char_count, state.wordCount),
                onIntent = onIntent,
            )
        },
    )
    ...
    if (state.isShowExitDialog) {
        LeafAlertDialog(
            ...
            title = stringResource(Res.string.editor_exit_dialog_title),
            description = stringResource(Res.string.editor_exit_dialog_description),
            negativeButton =
                LeafDialogButton(
                    text = stringResource(Res.string.editor_exit_dialog_cancel),
                    onClick = { onIntent(EditorIntent.ExitDialogDismiss) },
                ),
            positiveButton =
                LeafDialogButton(
                    text = stringResource(Res.string.editor_exit_dialog_confirm),
