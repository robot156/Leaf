...
import io.github.jean.core.designsystem.generated.resources.editor_record_placeholder
...
fun EditorRecordBlockField(
    ...
    LeafNoteTextField(
        state = state,
        placeholder = if (showPlaceholder) stringResource(Res.string.editor_record_placeholder) else null,
        modifier =
            modifier
                .fillMaxWidth()
