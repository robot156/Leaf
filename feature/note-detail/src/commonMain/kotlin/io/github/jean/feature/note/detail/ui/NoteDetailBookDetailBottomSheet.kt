...
import io.github.jean.core.designsystem.generated.resources.note_detail_book_description
import io.github.jean.core.designsystem.generated.resources.note_detail_book_external_link
import io.github.jean.core.designsystem.generated.resources.note_detail_book_isbn
    ...
    LeafBottomSheet(
        ...
        content = {
            Column(
                    ...
                    text =
                        listOfNotNull(
                            ...
                            uiModel.isbn13
                                ...
                                ?.let { stringResource(Res.string.note_detail_book_isbn, it) },
                        ).joinToString(" · "),
                    style = LeafTheme.typography.meta,
                ...
                if (uiModel.description.isNotBlank()) {
                    ...
                    Text(
                        text = stringResource(Res.string.note_detail_book_description),
        ...
        bottomBar =
            if (uiModel.link.isNotBlank()) {
                {
                    LeafSolidButton(
                        text = stringResource(Res.string.note_detail_book_external_link),
