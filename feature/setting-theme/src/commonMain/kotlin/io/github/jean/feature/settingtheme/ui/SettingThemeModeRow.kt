...
import io.github.jean.core.designsystem.generated.resources.setting_theme_system_follow
...
private fun Theme.getDisplayName(): String =
    when (this) {
        Theme.System -> stringResource(Res.string.setting_theme_system_follow)
