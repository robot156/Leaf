...
import io.github.jean.core.designsystem.generated.resources.setting_theme_sample_description
import io.github.jean.core.designsystem.generated.resources.setting_theme_sample_title
...
fun SettingThemeHero(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.setting_theme_sample_title),
        ...
        Text(
            text = stringResource(Res.string.setting_theme_sample_description),
