 ...
 */
@Serializable
internal data class BookContainerResponse(
...
internal fun BookContainerResponse.toDomain(): BookContainer =
    BookContainer(
...
internal fun BookResponse.toDomain(createdAt: Instant = now()): Book =
    Book(
        itemId = itemId,
