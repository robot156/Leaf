...
import io.github.jean.core.designsystem.generated.resources.common_cancel
import io.github.jean.core.designsystem.generated.resources.common_confirm
...
fun LeafDatePickerDialog(
    ...
    Dialog(onDismissRequest = onDismiss) {
        Column(
            ...
            // 선택된 날짜 헤더 — 세리프
            // String.format 은 JVM 전용이라 padStart 로 두 자리를 맞춘다.
            val month = selectedDate.month.number.toString().padStart(length = 2, padChar = '0')
            val day = selectedDate.day.toString().padStart(length = 2, padChar = '0')
            Text(
                text = "${selectedDate.year}년 ${month}월 ${day}일",
